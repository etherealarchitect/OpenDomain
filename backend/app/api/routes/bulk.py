...
@router.post("/register", response_model=BulkOperationResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/renew", response_model=BulkOperationResponse)
...
@router.post("/lock", response_model=BulkOperationResponse)
...
@router.post("/unlock", response_model=BulkOperationResponse)
